...
\begin{tikzpicture}[
  ...
  % Industry
  \node[ssbox, fill=blue!5, draw=blue!25, minimum width=1.2cm] (euse) at (0.1,-1.3) {Energy Use};
  \node[ssbox, fill=orange!5, draw=orange!25, minimum width=1.2cm] (fs) at (1.5,-1.3) {Feedstocks};
  % Buildings
  \node[ssbox, fill=purple!5, draw=purple!25, minimum width=1.2cm] (res) at (2.8,-1.3) {Residential};
  \node[ssbox, fill=purple!5, draw=purple!25, minimum width=1.2cm] (com) at (4.0,-1.3) {Commercial};
  % Transport
  \node[ssbox, fill=green!5, draw=green!25, minimum width=1.2cm] (pas) at (5.3,-1.3) {Passenger};
  \node[ssbox, fill=green!5, draw=green!25, minimum width=1.2cm] (frt) at (6.7,-1.3) {Freight};
  % Agriculture: no subsectors
  % Bunkers
  \node[ssbox, fill=gray!5, draw=gray!25, minimum width=1.2cm, font=\tiny\bfseries] (bavia) at (10.5,-1.3) {Intl. Aviation};
  \node[ssbox, fill=gray!5, draw=gray!25, minimum width=1.2cm, font=\tiny\bfseries] (bship) at (11.9,-1.3) {Intl. Shipping};
  ...
  \node[tbox] (eu_heat) at (2.8,-2.4) {Heating};
  \node[tbox] (eu_cool) at (3.7,-2.4) {Cooling};
  \node[tbox] (eu_oth)  at (4.6,-2.4) {Other};
  ...
  \node[sbox, fill=green!8, draw=green!40, minimum width=0.8cm, font=\tiny\bfseries] (p_sol)  at (-1.05,-6.3) {Solar};
  \node[sbox, fill=green!8, draw=green!40, minimum width=0.8cm, font=\tiny\bfseries] (p_wind) at (0,-6.3)     {Wind};
  \node[sbox, fill=green!8, draw=green!40, minimum width=0.8cm, font=\tiny\bfseries] (p_hyd)  at (1.05,-6.3) {Hydro};
  \node[sbox, fill=green!8, draw=green!40, minimum width=0.8cm, font=\tiny\bfseries] (p_u)    at (-0.55,-7.0) {Uranium};
  \node[sbox, fill=green!8, draw=green!40, minimum width=1.0cm, font=\tiny\bfseries] (p_geo)  at (0.55,-7.0)  {Geothermal};
