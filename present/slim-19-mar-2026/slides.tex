...
\begin{tikzpicture}[
  ...
  \node[cbox, minimum width=1.1cm] (c_sol)  at (3.2, 0)  {Solids};
  \node[cbox, minimum width=1.3cm] (c_liq)  at (5.0, 0)  {Refined Oil};
  \node[cbox, minimum width=1.1cm] (c_gas)  at (6.6, 0)  {Gas};
  \node[cbox, minimum width=1.1cm] (c_h2)   at (8.2, 0)  {H$_2$};
  \node[cbox, minimum width=1.1cm] (c_heat) at (9.8, 0)  {Heat};
  \node[cbox, minimum width=1.1cm] (c_biof) at (11.4, 0) {Biofuel};
  \node[cbox, minimum width=1.1cm] (c_bio)  at (13.0, 0) {Biomass};

  % Transformation (right side): SFP, OR, GP, H₂, DH, Biorefining, BP
  \node[tbox, minimum width=1.5cm] (tr_sfp)  at (3.0, -2)  {Solid Fuel\\Processing};
  \node[tbox, minimum width=1.5cm] (tr_ref)  at (4.8, -2)  {Oil\\Refining};
  \node[tbox, minimum width=1.5cm] (tr_gasp) at (6.6, -2)  {Gas\\Processing};
  \node[tbox, minimum width=1.5cm] (tr_h2)   at (8.4, -2)  {H$_2$\\Production};
  \node[tbox, minimum width=1.5cm] (tr_dh)   at (10.2, -2) {District\\Heating};
  \node[tbox, minimum width=1.5cm] (tr_bio)  at (12.0, -2) {Biorefining};
  \node[tbox, minimum width=1.5cm] (tr_bmp)  at (13.8, -2) {Biomass\\Processing};
