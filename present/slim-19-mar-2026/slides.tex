...
\begin{tikzpicture}[
  ...
  \node[sbox, fill=green!8, draw=green!40, minimum width=0.8cm, font=\tiny\bfseries] (p_sol)  at (-0.55,-6.3) {Solar};
  \node[sbox, fill=green!8, draw=green!40, minimum width=0.8cm, font=\tiny\bfseries] (p_wind) at (0.5,-6.3)   {Wind};
  \node[sbox, fill=green!8, draw=green!40, minimum width=0.8cm, font=\tiny\bfseries] (p_hyd)  at (1.55,-6.3) {Hydro};
  \node[sbox, fill=green!8, draw=green!40, minimum width=0.8cm, font=\tiny\bfseries] (p_u)    at (-0.05,-7.0) {Uranium};
  \node[sbox, fill=green!8, draw=green!40, minimum width=1.0cm, font=\tiny\bfseries] (p_geo)  at (1.05,-7.0)  {Geothermal};
