...
\begin{tikzpicture}[
  ...
  % Carriers (right side): Solids, Refined Oil, Gas, H₂, Heat, Biofuel, Biomass
  \node[cbox, minimum width=1.0cm] (c_sol)  at (3.8, 0)  {Solids};
  \node[cbox, minimum width=1.2cm] (c_liq)  at (5.3, 0)  {Refined Oil};
  \node[cbox, minimum width=1.0cm] (c_gas)  at (6.8, 0)  {Gas};
  \node[cbox, minimum width=1.0cm] (c_h2)   at (8.2, 0)  {H$_2$};
  \node[cbox, minimum width=1.0cm] (c_heat) at (9.6, 0)  {Heat};
  \node[cbox, minimum width=1.0cm] (c_biof) at (11.0, 0) {Biofuel};
  \node[cbox, minimum width=1.0cm] (c_bio)  at (12.4, 0) {Biomass};

  % Transformation (right side): SFP, OR, GP, H₂, DH, Biorefining, BP
  \node[tbox, minimum width=1.3cm, font=\tiny\bfseries] (tr_sfp)  at (3.5, -2)  {Solid Fuel\\Processing};
  \node[tbox, minimum width=1.3cm, font=\tiny\bfseries] (tr_ref)  at (5.0, -2)  {Oil\\Refining};
  \node[tbox, minimum width=1.3cm, font=\tiny\bfseries] (tr_gasp) at (6.5, -2)  {Gas\\Processing};
  \node[tbox, minimum width=1.3cm, font=\tiny\bfseries] (tr_h2)   at (8.0, -2)  {H$_2$\\Production};
  \node[tbox, minimum width=1.3cm, font=\tiny\bfseries] (tr_dh)   at (9.5, -2)  {District\\Heating};
