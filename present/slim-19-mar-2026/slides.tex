...
\textbf{\color{purple!60}Technology}
  ...
  & Two-factor learning (RND + LBD) + cross spillovers \\
\rowcolor{green!6}
...
\begin{tikzpicture}[
  ...
  % gcamdata contents
  \node<1->[inner sep=0] (gcam) at (-5.2, 0.3) {\includegraphics[width=2.4cm]{gcamdata.png}};
  ...
  % IAMC contents
  \node<3->[inner sep=0] (iamc) at (5.2, 0.2) {\includegraphics[width=2.8cm]{iamc.jpeg}};
...
\begin{frame}{Regional Classification: GCAM 32 Regions}
\centering
...
\begin{tikzpicture}[
  ...
  % ── Row 1: Sectors (y=0) ─────────────────────────────────────
  \node[sbox, fill=blue!12, draw=blue!60, minimum width=3.2cm, font=\small\bfseries] (ind) at (1.6,0) {Industry};
  \node[sbox, fill=purple!12, draw=purple!60, minimum width=3.2cm, font=\small\bfseries] (bld) at (5.0,0) {Buildings};
  \node[sbox, fill=green!10, draw=green!50!black, minimum width=3.2cm, font=\small\bfseries] (trn) at (8.4,0) {Transport};
  \node[sbox, fill=teal!10, draw=teal!50, minimum width=3.2cm, font=\small\bfseries] (agr) at (11.8,0) {Agriculture};
  \node[sbox, fill=gray!10, draw=gray!50, minimum width=3.2cm, font=\small\bfseries] (bnk) at (15.2,0) {Bunkers};

  % ── Row 2: Subsectors (y=-1.3) ──────────────────────────────
  % Industry
  \node[ssbox, fill=blue!5, draw=blue!25, minimum width=1.3cm] (euse) at (0.8,-1.3) {Energy Use};
  \node[ssbox, fill=orange!5, draw=orange!25, minimum width=1.3cm] (fs) at (2.4,-1.3) {Feedstocks};
  % Buildings
  \node[ssbox, fill=purple!5, draw=purple!25, minimum width=1.3cm] (res) at (4.2,-1.3) {Residential};
  \node[ssbox, fill=purple!5, draw=purple!25, minimum width=1.3cm] (com) at (5.8,-1.3) {Commercial};
  % Transport
  \node[ssbox, fill=green!5, draw=green!25, minimum width=1.3cm] (pas) at (7.6,-1.3) {Passenger};
  \node[ssbox, fill=green!5, draw=green!25, minimum width=1.3cm] (frt) at (9.2,-1.3) {Freight};
  % Agriculture: no subsectors
  % Bunkers
  \node[ssbox, fill=gray!5, draw=gray!25, minimum width=1.5cm, font=\tiny\bfseries] (bavia) at (14.2,-1.3) {Intl. Aviation};
  \node[ssbox, fill=gray!5, draw=gray!25, minimum width=1.5cm, font=\tiny\bfseries] (bship) at (16.2,-1.3) {Intl. Shipping};
  ...
  \node[tbox] (eu_heat) at (4.2,-2.4) {Heating};
  \node[tbox] (eu_cool) at (5.4,-2.4) {Cooling};
  \node[tbox] (eu_oth)  at (6.5,-2.4) {Other};
  ...
  % ── Row 4: Carriers (y=-3.8) — 8 items, full width ──────────
  \node[sbox, fill=violet!8, draw=violet!40, minimum width=1.3cm] (c_elec) at (0.5,-3.8)  {Electricity};
  \node[sbox, fill=violet!8, draw=violet!40, minimum width=1.3cm] (c_liq)  at (2.6,-3.8)  {Liquids};
  \node[sbox, fill=violet!8, draw=violet!40, minimum width=1.3cm] (c_gas)  at (4.6,-3.8)  {Gas};
  \node[sbox, fill=violet!8, draw=violet!40, minimum width=1.3cm] (c_heat) at (6.7,-3.8)  {Heat};
  \node[sbox, fill=violet!8, draw=violet!40, minimum width=1.3cm] (c_sol)  at (8.8,-3.8)  {Solids};
  \node[sbox, fill=violet!8, draw=violet!40, minimum width=1.3cm] (c_h2)   at (10.9,-3.8) {H$_2$};
  \node[sbox, fill=violet!8, draw=violet!40, minimum width=1.3cm] (c_biof) at (13.0,-3.8) {Biofuel};
  \node[sbox, fill=violet!8, draw=violet!40, minimum width=1.3cm] (c_bio)  at (15.1,-3.8) {Biomass};

  % ── Row 5: Transformation (y=-5.2) — 5 items ───────────────
  \node[sbox, fill=orange!15, draw=orange!60, minimum width=2.5cm] (tr_elec) at (1.5,-5.2)  {Elec.\ Generation};
  \node[sbox, fill=orange!15, draw=orange!60, minimum width=2.5cm] (tr_ref)  at (4.8,-5.2)  {Oil Refining};
  \node[sbox, fill=orange!15, draw=orange!60, minimum width=2.5cm] (tr_dh)   at (8.0,-5.2)  {District Heating};
  \node[sbox, fill=orange!15, draw=orange!60, minimum width=2.5cm] (tr_bio)  at (11.2,-5.2) {Biorefining};
  \node[sbox, fill=orange!15, draw=orange!60, minimum width=2.5cm] (tr_h2)   at (14.5,-5.2) {H$_2$ Production};

  % ── Row 6: Primary (y=-6.6) — 9 items, full width ──────────
  \node[sbox, fill=red!8, draw=red!40, minimum width=1.2cm] (p_coal)    at (0.5,-6.6)  {Coal};
  \node[sbox, fill=red!8, draw=red!40, minimum width=1.2cm] (p_oil)     at (2.3,-6.6)  {Oil};
  \node[sbox, fill=red!8, draw=red!40, minimum width=1.2cm] (p_gas)     at (4.1,-6.6)  {Gas};
  \node[sbox, fill=green!8, draw=green!40, minimum width=1.2cm] (p_u)   at (5.9,-6.6)  {Uranium};
  \node[sbox, fill=green!8, draw=green!40, minimum width=1.2cm] (p_bio) at (7.7,-6.6)  {Biomass};
  \node[sbox, fill=green!8, draw=green!40, minimum width=1.2cm] (p_wind)at (9.5,-6.6)  {Wind};
  \node[sbox, fill=green!8, draw=green!40, minimum width=1.2cm] (p_sol) at (11.3,-6.6) {Solar};
  \node[sbox, fill=green!8, draw=green!40, minimum width=1.2cm] (p_hyd) at (13.1,-6.6) {Hydro};
  \node[sbox, fill=green!8, draw=green!40, minimum width=1.2cm] (p_geo) at (15.1,-6.6) {Geothermal};

  % ── Colored lines by carrier ──────────────────────────────────
  % Yellow = Electricity chain
  \draw[yellow!70!orange, line width=0.7pt] (p_coal.north) -- (tr_elec.south);
  \draw[yellow!70!orange, line width=0.7pt] (p_gas.north) -- (tr_elec.south);
  \draw[yellow!70!orange, line width=0.7pt] (p_oil.north) -- (tr_elec.south);
  \draw[yellow!70!orange, line width=0.7pt] (p_u.north) -- (tr_elec.south);
  \draw[yellow!70!orange, line width=0.7pt] (p_wind.north) -- (tr_elec.south);
  \draw[yellow!70!orange, line width=0.7pt] (p_sol.north) -- (tr_elec.south);
  \draw[yellow!70!orange, line width=0.7pt] (p_hyd.north) -- (tr_elec.south);
  \draw[yellow!70!orange, line width=0.7pt] (p_geo.north) -- (tr_elec.south);
  \draw[yellow!70!orange, line width=0.7pt] (tr_elec.north) -- (c_elec.south);
  % Red = Liquids chain
  \draw[red!70!black, line width=0.7pt] (p_oil.north) -- (tr_ref.south);
  \draw[red!70!black, line width=0.7pt] (tr_ref.north) -- (c_liq.south);
  % Magenta = District Heating chain
  \draw[pink!70!red, line width=0.7pt] (p_gas.north) -- (tr_dh.south);
  \draw[pink!70!red, line width=0.7pt] (p_coal.north) -- (tr_dh.south);
  \draw[pink!70!red, line width=0.7pt] (p_oil.north) -- (tr_dh.south);
  \draw[pink!70!red, line width=0.7pt] (p_bio.north) -- (tr_dh.south);
  \draw[pink!70!red, line width=0.7pt] (tr_dh.north) -- (c_heat.south);
  % Green = Biofuel chain
  \draw[green!60!black, line width=0.7pt] (p_bio.north) -- (tr_bio.south);
  \draw[green!60!black, line width=0.7pt] (tr_bio.north) -- (c_biof.south);
  % Blue = H2 chain
  \draw[blue!60, line width=0.7pt] (p_gas.north) -- (tr_h2.south);
  \draw[blue!60, line width=0.7pt] (tr_h2.north) -- (c_h2.south);
  % ── Bypass lines (behind nodes) ──
  \begin{pgfonlayer}{background}
  % Blue dashed = Electrolysis (Elec → H2 Prod)
  \draw[-{Stealth[length=3pt]}, blue!50, line width=0.7pt, dashed] (c_elec.south) to[bend right=12] (tr_h2.west);
  % Cyan = Gas bypass
  \draw[cyan!70!blue, line width=0.7pt, dashed] (p_gas.north) -- (c_gas.south);
  % Gray = Solids bypass
  \draw[gray!50, line width=0.7pt, dashed] (p_coal.north) -- (c_sol.south);
  % Green = Biomass bypass
  \draw[green!50!black, line width=0.7pt, dashed] (p_bio.north) -- (c_bio.south);
  \end{pgfonlayer}

  % ── Row labels ───────────────────────────────────────────────
  \node[font=\scriptsize\color{TextLight}, anchor=east] at (-0.8,0) {Sectors};
  \node[font=\scriptsize\color{TextLight}, anchor=east] at (-0.8,-1.3) {Subsectors};
  \node[font=\scriptsize\color{TextLight}, anchor=east] at (-0.8,-2.4) {End Uses};
  \node[font=\scriptsize\color{TextLight}, anchor=east] at (-0.8,-3.8) {Carriers};
  \node[font=\scriptsize\color{TextLight}, anchor=east] at (-0.8,-5.2) {Transform.};
  \node[font=\scriptsize\color{TextLight}, anchor=east] at (-0.8,-6.6) {Primary};
\end{tikzpicture}
\end{frame}
...
\begin{tikzpicture}[
  ...
  % ── Row 1: Carriers (y=0) — 8 items ───────────────────────────
  \node[sbox, fill=violet!8, draw=violet!40, minimum width=1.3cm] (c_elec) at (0.8,0)  {Electricity};
  \node[sbox, fill=violet!8, draw=violet!40, minimum width=1.3cm] (c_liq)  at (3.0,0)  {Liquids};
  \node[sbox, fill=violet!8, draw=violet!40, minimum width=1.3cm] (c_gas)  at (5.1,0)  {Gas};
  \node[sbox, fill=violet!8, draw=violet!40, minimum width=1.3cm] (c_heat) at (7.2,0)  {Heat};
  \node[sbox, fill=violet!8, draw=violet!40, minimum width=1.3cm] (c_sol)  at (9.3,0)  {Solids};
  \node[sbox, fill=violet!8, draw=violet!40, minimum width=1.3cm] (c_h2)   at (11.4,0) {H$_2$};
  \node[sbox, fill=violet!8, draw=violet!40, minimum width=1.3cm] (c_biof) at (13.5,0) {Biofuel};
  \node[sbox, fill=violet!8, draw=violet!40, minimum width=1.3cm] (c_bio)  at (15.6,0) {Biomass};

  % ── Row 2: Transformation (y=-2.4) — 5 items ──────────────────
  \node[sbox, fill=orange!15, draw=orange!60, minimum width=2.5cm] (tr_elec) at (1.8,-2.4)  {Elec.\ Generation};
  \node[sbox, fill=orange!15, draw=orange!60, minimum width=2.5cm] (tr_ref)  at (5.2,-2.4)  {Oil Refining};
  \node[sbox, fill=orange!15, draw=orange!60, minimum width=2.5cm] (tr_dh)   at (8.5,-2.4)  {District Heating};
  \node[sbox, fill=orange!15, draw=orange!60, minimum width=2.5cm] (tr_bio)  at (11.8,-2.4) {Biorefining};
  \node[sbox, fill=orange!15, draw=orange!60, minimum width=2.5cm] (tr_h2)   at (15.1,-2.4) {H$_2$ Production};

  % ── Row 3: Primary (y=-4.8) — 9 items ─────────────────────────
  \node[sbox, fill=red!8, draw=red!40, minimum width=1.2cm] (p_coal)    at (0.5,-4.8)  {Coal};
  \node[sbox, fill=red!8, draw=red!40, minimum width=1.2cm] (p_oil)     at (2.3,-4.8)  {Oil};
  \node[sbox, fill=red!8, draw=red!40, minimum width=1.2cm] (p_gas)     at (4.1,-4.8)  {Gas};
  \node[sbox, fill=green!8, draw=green!40, minimum width=1.2cm] (p_u)   at (5.9,-4.8)  {Uranium};
  \node[sbox, fill=green!8, draw=green!40, minimum width=1.2cm] (p_bio) at (7.7,-4.8)  {Biomass};
  \node[sbox, fill=green!8, draw=green!40, minimum width=1.2cm] (p_wind)at (9.5,-4.8)  {Wind};
  \node[sbox, fill=green!8, draw=green!40, minimum width=1.2cm] (p_sol) at (11.3,-4.8) {Solar};
  \node[sbox, fill=green!8, draw=green!40, minimum width=1.2cm] (p_hyd) at (13.1,-4.8) {Hydro};
  \node[sbox, fill=green!8, draw=green!40, minimum width=1.2cm] (p_geo) at (15.2,-4.8) {Geothermal};

  % ── Solid lines: Primary → Transformation → Carrier ────────────
  % Yellow = Electricity chain
  \foreach \s in {p_coal, p_oil, p_gas, p_u, p_bio, p_wind, p_sol, p_hyd, p_geo} {
    \draw[yellow!70!orange, line width=0.7pt] (\s.north) -- (tr_elec.south);
  }
  \draw[yellow!70!orange, line width=0.7pt] (tr_elec.north) -- (c_elec.south);
  % Red = Liquids chain
  \draw[red!70!black, line width=0.7pt] (p_oil.north) -- (tr_ref.south);
  \draw[red!70!black, line width=0.7pt] (tr_ref.north) -- (c_liq.south);
  % Pink = District Heating chain
  \foreach \s in {p_coal, p_oil, p_gas, p_bio} {
    \draw[pink!70!red, line width=0.7pt] (\s.north) -- (tr_dh.south);
  }
  \draw[pink!70!red, line width=0.7pt] (tr_dh.north) -- (c_heat.south);
  % Green = Biofuel chain
  \draw[green!60!black, line width=0.7pt] (p_bio.north) -- (tr_bio.south);
  ...
  % ── Bypass / dashed lines (behind nodes) ───────────────────────
  \begin{pgfonlayer}{background}
  % Electrolysis: Electricity carrier → H2 Production
  \draw[-{Stealth[length=3pt]}, blue!50, line width=0.7pt, dashed] (c_elec.south) to[bend right=12] (tr_h2.north west);
  % Gas bypass (direct primary → carrier)
  \draw[cyan!70!blue, line width=0.7pt, dashed] (p_gas.north) -- (c_gas.south);
  % Solids bypass
  \draw[gray!50, line width=0.7pt, dashed] (p_coal.north) -- (c_sol.south);
  % Biomass bypass
  ...
  % ── Row labels ─────────────────────────────────────────────────
  \node[font=\scriptsize\color{TextLight}, anchor=east] at (-0.5,0) {Carriers};
  \node[font=\scriptsize\color{TextLight}, anchor=east] at (-0.5,-2.4) {Transformation};
  \node[font=\scriptsize\color{TextLight}, anchor=east] at (-0.5,-4.8) {Primary};
\end{tikzpicture}
\end{frame}
...
\rowcolor{SpruceGreen!8}
Forward solve & 42s \\
{\scriptsize \quad 26 periods $\times$ $\sim$1.6s/period} & \\
{\scriptsize \quad 3 FE recal rounds + inline recal} & \\
{\scriptsize \quad per iter: $F(\mathbf{x})$ over 32 regions} & \\
\midrule
\textbf{Total} & \textbf{$\sim$79s} \\
\bottomrule
\end{tabular}
...
\vspace{-0.3em}
{\small \textbf{FE: CC\,=\,1.0000, MAE\,=\,0.7\,EJ} (MAPE $<0.1\%$). All sectors 0\% deviation 2025--2100.}
\vspace{0.2em}
...
\vspace{-0.3em}
{\small \textbf{Elec gen: 0.0\% deviation all periods.} H$_2$ production: 0.0\%. District heat: 0.0\%.}
\vspace{0.2em}
...
\vspace{-0.3em}
{\small Generation technology shares --- dashed\,=\,GCAM, solid\,=\,GHIM.}
\vspace{0.2em}
...
\footnotesize
\begin{tabular}{@{}llll@{}}
\textbf{Level 1} & $\mathrm{KL} = \mathrm{CES}(K,\, L;\; \sigma_{KL}\!=\!0.8)$
  & & Capital--Labor \\[3pt]
\textbf{Level 2} & $E_{\mathrm{val}} = \mathrm{CES}(E_{\mathrm{EL}},\, E_{\mathrm{NEL}};\; \sigma_{E}\!=\!2.0)$
  & & Electricity--Non-elec \\[3pt]
\textbf{Level 3} & $\mathrm{KLE} = A_{\mathrm{KLE}} \cdot \mathrm{CES}(\mathrm{VA},\, E_{\mathrm{val}};\; \sigma_{KLE}\!=\!0.4)$
  & & Value-added--Energy \\[3pt]
\textbf{Level 4} & $Q = A_{\mathrm{KLEM}} \cdot \mathrm{CES}(\mathrm{KLE},\, M;\; \sigma_{KLEM}\!=\!0.2)$
  & & Gross output \\
\end{tabular}
\end{tcolorbox}
...
% ── (2/5) Scale Factors ──────────────────────────────────────────
\begin{frame}[t]{Formal Calibration (2/4): Scale Factors $A$}
\vspace{-0.3em}

\begin{tcolorbox}[infobox, colback=blue!6, colframe=blue!60, top=4pt, bottom=4pt, title={Scale Factors (base year, time-invariant)}]
\footnotesize
Each nest gets a scale factor so CES output matches observed values:
\begin{align*}
A_{\mathrm{KLE}} &= \mathrm{KLE}_0 \;/\; \mathrm{CES}(\mathrm{VA}_0,\, E_{\mathrm{val},0})
  & \text{where } \mathrm{KLE}_0 &= \mathrm{GDP}_0 + p_E \!\cdot\! E_0 \\[4pt]
A_{\mathrm{KLEM}} &= Q_0 \;/\; \mathrm{CES}(\mathrm{KLE}_0,\, M_0)
...
\item $\mathrm{VA}_0 = \mathrm{GDP}_0 = r\!\cdot\! K + w\!\cdot\! L$: factor income, enforced by TFP calibration
...
% ── (3/5) Base-Year TFP ──────────────────────────────────────────
\begin{frame}[t]{Formal Calibration (3/4): Base-Year TFP}
\vspace{-0.3em}

\begin{tcolorbox}[infobox, colback=orange!6, colframe=orange!70!black, top=4pt, bottom=4pt, title={Base-Year TFP$_0$ (iterative calibration)}]
\footnotesize
Find $\mathrm{TFP}_0$ such that $\mathrm{GDP} = Q - p_E\!\cdot\! E - m\!\cdot\! Q = \mathrm{GDP}_0$:

\begin{align*}
&\text{Initial guess: } \mathrm{TFP} = \mathrm{GDP}_0 \,/\, \mathrm{CES}_{KL}(K_0,\, L_0) \\[6pt]
&\textbf{repeat:} \\
&\quad \mathrm{VA} = \mathrm{TFP} \cdot \mathrm{CES}_{KL}(K_0,\, L_0) \\
...
&\quad \mathrm{TFP} \leftarrow \mathrm{TFP} \times \mathrm{GDP}_0 \,/\, \mathrm{GDP}_{\mathrm{out}} \\[4pt]
...
\item TFP$_0$ ensures the full chain KL $\!\to\!$ KLE $\!\to\!$ Q $\!\to\!$ GDP reproduces GDP$_0$ exactly
\end{itemize}
\end{tcolorbox}
...
\begin{frame}[t]{Formal Calibration (4/4): Future TFP Trajectory}
\vspace{-0.3em}

\begin{tcolorbox}[infobox, colback=orange!6, colframe=orange!70!black, top=4pt, bottom=4pt, title={TFP$(t)$ via Bisection (every 5-year period)}]
\footnotesize
Given: $K(t)$ from capital accumulation, $L(t)$ from SSP population,
$p_E(t)$ from calibration pass.

\begin{align*}
\mathrm{VA}(t) &= \mathrm{TFP}(t) \cdot \mathrm{CES}_{KL}\!\big(K(t),\, L(t)\big) \\[4pt]
...
\vspace{-0.5em}
Bisect TFP$(t)$ until $\mathrm{GDP}(t) = \mathrm{GDP}_{\mathrm{SSP}}(t)$
