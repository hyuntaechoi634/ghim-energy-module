...
\begin{tikzpicture}[
  ...
  % Spacing: 1.8 interval, 8 boxes starting at x=0
  ...
  \node[sbox, fill=green!8, draw=green!40, minimum width=0.8cm, font=\tiny\bfseries] (p_sol)  at (-0.7,-6.3) {Solar};
  \node[sbox, fill=green!8, draw=green!40, minimum width=0.8cm, font=\tiny\bfseries] (p_wind) at (0,-6.3)    {Wind};
  \node[sbox, fill=green!8, draw=green!40, minimum width=0.8cm, font=\tiny\bfseries] (p_hyd)  at (0.7,-6.3)  {Hydro};
  \node[sbox, fill=green!8, draw=green!40, minimum width=0.8cm, font=\tiny\bfseries] (p_u)    at (-0.4,-7.0) {Uranium};
  ...
  \node[sbox, fill=red!8, draw=red!40, minimum width=1.0cm] (p_coal) at (\cs*1.5,-6.4) {Coal};
  \node[sbox, fill=red!8, draw=red!40, minimum width=1.0cm] (p_oil)  at (\cs*2.5,-6.4) {Oil};
  \node[sbox, fill=red!8, draw=red!40, minimum width=1.0cm] (p_gas)  at (\cs*3.5,-6.4) {Gas};
  \node[sbox, fill=green!8, draw=green!40, minimum width=1.0cm] (p_bio) at (\cs*5.5,-6.4) {Biomass};
  ...
  \foreach \s in {p_coal, p_oil, p_gas, p_bio} {
    \draw[yellow!50!orange, line width=0.5pt, opacity=0.4] (\s.north west) -- (tr_elec.south east);
  }
  \end{pgfonlayer}
