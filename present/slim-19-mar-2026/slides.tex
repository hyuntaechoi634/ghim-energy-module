...
\begin{tikzpicture}[
  ...
  % ── Links ──────────────────────────────────────────────────
  % ── Curved arcs: multiple primaries → transformation (logit competition) ──
  % Elec Gen: all primaries (elec-only group + fossil/biomass)
  ...
  \begin{pgfonlayer}{background}
  \draw[yellow!70!orange, line width=0.6pt, opacity=0.7] (p_coal.north) to[bend right=15] (tr_elec.south);
  \draw[yellow!70!orange, line width=0.6pt, opacity=0.7] (p_oil.north) to[bend right=12] (tr_elec.south);
  \draw[yellow!70!orange, line width=0.6pt, opacity=0.7] (p_gas.north) to[bend right=8] (tr_elec.south);
  \draw[yellow!70!orange, line width=0.6pt, opacity=0.7] (p_bio.north) to[bend left=10] (tr_elec.south);
  \end{pgfonlayer}
  % Solid Fuel Processing (1:1)
  ...
  % H2 Production (gas + biomass, curved)
  \draw[blue!60, line width=0.6pt] (p_gas.north) to[bend left=10] (tr_h2.south);
  \draw[blue!60, line width=0.6pt] (p_bio.north) to[bend right=8] (tr_h2.south);
  \draw[blue!60, line width=0.6pt] (tr_h2.north) -- (c_h2.south);
  % District Heating (coal, gas, biomass, curved)
  \draw[pink!70!red, line width=0.6pt] (p_coal.north) to[bend left=12] (tr_dh.south);
  \draw[pink!70!red, line width=0.6pt] (p_gas.north) to[bend left=8] (tr_dh.south);
  \draw[pink!70!red, line width=0.6pt] (p_bio.north) to[bend right=10] (tr_dh.south);
...
\begin{tikzpicture}[
  ...
  % District Heating (coal, gas, biomass → heat, curved arcs)
  \draw[pink!70!red, link] (p_coal.north) to[bend left=12] (tr_dh.south);
  \draw[pink!70!red, link] (p_gas.north) to[bend left=8] (tr_dh.south);
  \draw[pink!70!red, link] (p_bio.north) to[bend right=10] (tr_dh.south);
  \draw[pink!70!red, link] (tr_dh.north) -- (c_heat.south);
  % H2 Production (gas + biomass → H2, curved arcs)
  \draw[blue!60, link] (p_gas.north) to[bend left=10] (tr_h2.south);
  \draw[blue!60, link] (p_bio.north) to[bend right=8] (tr_h2.south);
  \draw[blue!60, link] (tr_h2.north) -- (c_h2.south);
  % Biorefining (biomass → biofuel, 1:1)
  \draw[green!60!black, link] (p_bio.north) -- (tr_bio.south);
  \draw[green!60!black, link] (tr_bio.north) -- (c_biof.south);
  % Biomass Processing (biomass → biomass carrier, 1:1)
  \draw[green!50!black, link] (p_bio.north) -- (tr_bmp.south);
  \draw[green!50!black, link] (tr_bmp.north) -- (c_bio.south);

  % Multi-use primaries → Elec Gen (curved arcs, logit competition)
  \begin{pgfonlayer}{background}
  \draw[yellow!70!orange, link, opacity=0.7] (p_coal.north) to[bend right=15] (tr_elec.south);
  \draw[yellow!70!orange, link, opacity=0.7] (p_oil.north) to[bend right=12] (tr_elec.south);
  \draw[yellow!70!orange, link, opacity=0.7] (p_gas.north) to[bend right=8] (tr_elec.south);
  \draw[yellow!70!orange, link, opacity=0.7] (p_bio.north) to[bend left=10] (tr_elec.south);
